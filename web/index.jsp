  ...
  <div class="header_bg">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="logo" href="index.jsp">MyVersity</a>
...
<div class="newsletter_section layout_padding">
  <div class="container">
    ...
    <p class="dolor_text">MyVersity dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip </p>
  </div>
</div>
...
<script type="text/javascript"src="${pageContext.request.contextPath}/js/plugin.js"></script>
<!-- sidebar -->
...
<script type="text/javascript"src="${pageContext.request.contextPath}/js/jquery.fancybox.min.js"></script>
</body>
