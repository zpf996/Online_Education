...
<%@ page import="dao.imp.paymentDaoImp" %>
            ...
            <div class="row">
                <table id="customers">
                    ...
                    <%
                        ...
                        PaymentDao u= new paymentDaoImp();
                        List<Payment> u1 = u.getUserAll();
                        for(Payment payment:u1)
                        {%>
                    <tr>
                        <%
                            if(payment.getUser_id().equals(session.getAttribute("name")))
                            {
                        %>
                        <td><%=payment.getCourse_id()%></td>
                        <td><%=payment.getPayment_id()%></td>
                        <td><%=payment.getDate()%></td>
                        <td><%=payment.getAmount()%></td>
                        <td><%=payment.getType()%></td>
                        <td><%=payment.getRemarks()%></td>
                        <td><a href="Course_content.jsp">View</a></td>
                        <%}%>
                    </tr>
                    <%}%>
                    <br>
