...
<%@ page import="servlet.Course_Content" %>
<%@ page import="dao.Course_contentDao" %>
<%@ page import="dao.imp.Course_contentDaoImp" %>
<%@ page import="bean.Course_content" %>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Courses_type.jsp">Course</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="services_section_2">
            <div class="row">
               ...
               <%
                   ...
                   Course_contentDao u= new Course_contentDaoImp();
                   List<Course_content> u1 = u.getUserAll();
                   for(Course_content course_content:u1)

                   {%>
                    <tr>
                        <%
//                            if(course_content.getCourse_id().equals(session.getAttribute("id")))
//                            {
                        %>
                        <td><%=course_content.getContent_id()%></td>
                        <td><%=course_content.getCourse_id()%></td>
                        <td><%=course_content.getContent_topic_name()%></td>
                        <td><%=course_content.getDetail_content()%></td>
                        <td><a href=""> <%=course_content.getVideo_link()%></a></td>
                        <td><%=course_content.getReferences()%></td>
                        <td><a href="Register_course.jsp">buy</a> </td>
<%--                        <%}%>--%>
                    </tr>
                    <%}%>
                </table>
                    ...
                    <div class="information_main">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="Courses_type.jsp">Course</a></li>
