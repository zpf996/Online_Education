...
<div class="services_section layout_padding">
    <div class="container">
        ...
        <div class="services_section_2">
            <div class="row">
                <form action="Register_payment" method="post">
                <table id="customers">
                    <tr>
                        <th>Payment_Id</th>
                        <th>User_Id</th>
                   ...
                   <tr>
                       <td><input type="text" required="required" name="payment_id" ></td>
                       <td><input type="text" required="required" name="user_id" ></td>
                       <td><input type="text" required="required" name="course_id" ></td>
                       <td><input type="date" required="required" name="date" ></td>
                       <td><input type="text" required="required" name="amounte" ></td>
                       <td><input type="text" required="required" name="type" ></td>
                       <td><input type="text" required="required" name="remaeks" ></td>
