            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="image_main">
                        ...
                        <div class="text_main">
                            <div class="seemore_text"><a href="Course_View.jsp">Art And Design</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="image_main">
                        ...
                        <div class="text_main">
                            <div class="seemore_text"><a href="Course_View_1.jsp">Business Stady</a>Science</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="image_main">
                        ...
                        <div class="text_main">
                            <div class="seemore_text"><a href="Course_View_2.jsp">Business Stady</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="image_main">
                        ...
                        <div class="text_main">
                            <div class="seemore_text"><a href="Course_View_3.jsp">English Speaking</a></div>
                        </div>
                    </div>
                </div>
            </div>
